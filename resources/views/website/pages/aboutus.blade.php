            ...
            <div class="row ">
                <div class="col-lg-12 about-banner g-0">
                    ...
                    <p class="mb-4 about_banner_para">We rely on our principles to guide how we interact with each
                        ...
                        values. Aspirations and our cultural language – lived and embraced by every employee at our
                        firm. The people we serve entrust us to help them prepare for the future. Our culture is defined
                        by the deep sense of responsibility we feel to our clients and to each other.</p>
                    --}}
                </div>
            </div>
        </div>
...
<div class="container mt-1 mb-2">
    <div class="row founder_section_row">
        ...
        <div class="col-md-3 col-lg-7 col-sm-3">
            <div class="row g-5 d-grid">
                <div class="fcard">
                    <div class="fcard_about" style="margin-top:0; font-size:14px;">

                        <p class="text-align-justify">Fibovix Wealth Management provides financial advice and solutions
                            to private, institutional, and corporate clients worldwide. Headquartered in Nariman Point,
                            Mumbai, we are present in all major financial assets worldwide. We provide corporate,
                            institutional, and wealth management clients with expert advice, innovative solutions,
                            execution, and comprehensive access to international capital markets. We deliver investment
                            products, technology, and tools – helping millions meet immediate spending needs, build
                            wealth, and retire securely. We are a fiduciary to our clients. We’re investing for the
                            future on behalf of our clients, inspiring our employees, and supporting our local
                            communities. Our purpose is to help more and more people experience financial well-being.
                            Together with our clients, we’re contributing to a more equitable and resilient world –
                            today and for generations to come. Our investment approach is informed by three principles:
                            we start by understanding the client’s investment objectives; we seek the best risk-adjusted
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6 col-lg-6 col-sm-6 d-flex justify-content-center">
            <p>We are driven by a vision of a better retirement. We believe that people deserve financial security
                across their lifetimes and that retirement should be within reach for everyone. To make this a reality,
                we are building better solutions, and making them more accessible.</p>
        ...
        <div class="col-md-12">
            ...
            <div class="main col-lg-11 col-md-11 col-sm-11">
                ...
                <div class="sub_main">
                    ...
                    <p class="our_advisor_p">Our team, clients, communities, and shareholders are at the center of
                        everything we do. Through our tailored solutions spanning investment and commercial banking,
                        payments processing, and asset management, we're relentlessly focused on serving our clients and
                        driving sustainable impact for our communities.</p>
                </div>
                    ...
                    <div class="card-header" id="headingOne">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                ...
                                and securities services for our clients. These services are delivered by teams working
                ...
                <div class="card">
                    <div class="card-header" id="headingTwo">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                            data-bs-parent="#accordionExample">
                            <div class="card-body">
                                Our purpose is to help more and more people experience financial well-being. Together
                                with our clients, we’re contributing to a more equitable and resilient world – today and
                ...
                <div class="card">
                    <div class="card-header" id="headingThree">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                            data-bs-parent="#accordionExample">
                            <div class="card-body">
                                Our people are our greatest asset – we say it often and with good reason. It is only
                                with the determination and dedication of our people that we can serve our clients,
                                generate long-term value for our shareholders, and contribute to the broader public.
                                Fibovix economists and experts share insights on macro trends shaping the global
                                economy.
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" id="headingFour">
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                            data-bs-parent="#accordionExample">
                            <div class="card-body">
                                Fibovix's investment approach is informed by three principles: we start by understanding
                                the client’s investment objectives; we seek the best risk-adjusted returns within the
                                scope of the mandate they give us; and we underpin our work with research, data, and
                                analytics. We apply those same principles to sustainability and the low-carbon
                                transition.
                                At Fibovix, we believe we’re at our best when our employees connect their personal
                                purpose to their work and our firm’s purpose. In our “What’s Your Why” series, employees
                                share how they bring their passions to what they do.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header" id="headingFive">
                        ...
                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive"
                            data-bs-parent="#accordionExample">
                            <div class="card-body">
                                We frequently express that our team members are our most valuable treasure, and it's a
                                sentiment we deeply believe in. Their unwavering commitment and dedication empower us to
                                provide excellent service to our clients, create enduring value for our shareholders,
                                and make meaningful contributions to society at large.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="text-slider">
                            ...
                            <p>Are you considering the potential value of having a dedicated advisor during specific
                    ...
                    <div class="carousel-item">
                        <div class="text-slider">
                            ...
                            <p>Having a dedicated advisor at certain times in your life can be valuable. Are any of
                                these on your radar?</p>
                ...
                <div class="container about_contact_form">
                    ...
                    <div class="row about_contact_row">
                        ...
                        <form class="row g-3 needs-validation" action="{{ url('add-about-us-contactus') }}" id="regForm"
                            ...
                            <div class="col-md-12 py-3 captcha_set d-flex justify-content-center"
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <p class="form_para mt-4"> <input type="checkbox" id="agree_checkbox"
                                        name="agree_checkbox" onchange="enableSubmit()" value="">
        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="wtsubmain">
                    ...
                    <br />
                    <p class="wtsubpara">
                        Together with your advisor, you will delineate and prioritize your objectives, assess your
                        financial standing, and assess trade-offs to formulate a personalized, easily understandable,
                        and comprehensive plan using our optimized tools. In the event of changes in your situation, you
                        and your advisor can revise the plan to ensure you remain on course toward your goals.
                    </p>
                </div>
            </div>
