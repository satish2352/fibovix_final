...
<div class="main-panel">
    <div class="content-wrapper mt-6">
        ...
        <form class="forms-sample" action="{{ route('add-service-details') }}" method="POST" enctype="multipart/form-data"
            id="regForm">
            @csrf
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 text-center">
                    ...
                    <span><a href="{{ route('list-service-details') }}" class="btn btn-sm btn-primary ">Back</a></span>
                </div>
            </div>
        </form>
    </div>
