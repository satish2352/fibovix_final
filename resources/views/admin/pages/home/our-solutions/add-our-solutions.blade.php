...
<div class="main-panel">
    <div class="content-wrapper mt-6">
        ...
        <form class="forms-sample" action="{{ route('add-our-solutions') }}" method="POST" enctype="multipart/form-data"
            id="regForm">
            @csrf
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 text-center">
                    ...
                    <span><a href="{{ route('list-our-solutions') }}" class="btn btn-sm btn-primary ">Back</a></span>
                </div>
            </div>
        </form>
    </div>
