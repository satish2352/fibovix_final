...
@section('content')
    <div class="main-panel">
            ...
            <div class="page-header">
                {{--<h3 class="page-title">
                    Career
                        ...
                        <a href="{{ route('add-traders') }}" class="btn btn-sm btn-primary ml-3">+
                            Add</a>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('list-traders') }}">Master</a></li>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                    ...
                                                                    <a
                                                                        href="{{ route('edit-traders', base64_encode($item->id)) }}"
        ...
        <form method="POST" action="{{ url('/delete-traders') }}" id="deleteform">
            @csrf
            <input type="hidden" name="delete_id" id="delete_id" value="">
        </form>
        <form method="POST" action="{{ url('/show-traders') }}" id="showform">
            @csrf
            <input type="hidden" name="show_id" id="show_id" value="">
        </form>
        <form method="POST" action="{{ url('/update-active-traders') }}" id="activeform">
            @csrf
