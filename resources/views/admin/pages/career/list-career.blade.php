            ...
            <div class="page-header">
                {{--<h3 class="page-title">
                    Career
                        ...
                        <a href="{{ route('add-services') }}" class="btn btn-sm btn-primary ml-3">+
                            Add</a>
                                            ...
                                            <tbody>
                                                @foreach ($get_careerList as $item)
                                                    <tr>
                                                        ...
                                                        <td>
    <a href="{{ Config::get('DocumentConstant.RESUME_VIEW') . $item->resume }}" download="{{ Config::get('DocumentConstant.RESUME_VIEW') . $item->resume }}">
        Download Resume
    </a>
</td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                    ...
                                                                    <a
                                                                        href="{{ route('edit-services', base64_encode($item->id)) }}"
        ...
        <form method="POST" action="{{ url('/delete-services') }}" id="deleteform">
            @csrf
            <input type="hidden" name="delete_id" id="delete_id" value="">
        </form>
        <form method="POST" action="{{ url('/show-services') }}" id="showform">
            @csrf
