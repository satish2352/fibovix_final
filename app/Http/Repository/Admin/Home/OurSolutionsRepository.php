...
class OurSolutionsRepository  {
    ...
    public function getAll(){
        try {
            $data_output = OurSolutions::orderBy('updated_at', 'desc')->get();
            return $data_output;
        } catch (\Exception $e) {
            return $e;
        }
     ...
     public function addAll($request){
        try {
            ...
            $finalOutput = OurSolutions::find($last_insert_id); // Assuming $request directly contains the ID
    ...
    public function getById($id){
        try {
            $dataOutputByid = OurSolutions::find($id);
            if ($dataOutputByid) {
    ...
    public function updateAll($request){
        try {
            $return_data = array();
            $dataOutput = OurSolutions::find($request->id);
    ...
    public function updateOne($request){
        try {
            $updateOutput = OurSolutions::find($request); // Assuming $request directly contains the ID
    ...
    public function deleteById($id){
            try {
                $deleteDataById = OurSolutions::find($id);
                if ($deleteDataById) {
